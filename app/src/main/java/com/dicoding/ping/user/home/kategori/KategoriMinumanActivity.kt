...
import com.dicoding.ping.user.home.kategori.model.Minuman
import com.dicoding.ping.user.home.kategori.adapter.MinumanAdapter
...
class KategoriMinumanActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val minumanList = listOf(
            Minuman("Iced Tea", "Fresh sweet iced tea", "Rp 5.000",
                R.drawable.ic_launcher_background
            ),
            Minuman("Orange Juice", "Fresh orange juice", "Rp 10.000",
                R.drawable.ic_launcher_background
            )
        )
